      ...
      <div className="w-full max-w-sm">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 space-y-6">
          <div className="text-center">
            ...
            />
            <h1 className="text-xl font-bold">Cadastro de Organizador</h1>
            <p className="text-slate-500 text-sm mt-1">Copa Interclasses Helyos</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm text-slate-400 mb-1.5">Código de convite</label>
              <input
                type="text"
                ...
                placeholder="Código enviado pelo admin"
                required
              />
            </div>
            <div>
          ...
          <p className="text-center text-xs text-slate-600">
            Já tem conta?{' '}
            <a href="/admin/login" className="text-slate-400 hover:text-white transition-colors">
              Entrar
            </a>
          </p>
        </div>
